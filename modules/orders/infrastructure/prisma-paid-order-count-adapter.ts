 ...
 *
 * The cart module needs to know if a user has any completed orders to determine
 * whether the first-purchase discount applies (spec REQ-CART-016). The orders
 * module is the source of truth for that purchase history. This adapter implements
